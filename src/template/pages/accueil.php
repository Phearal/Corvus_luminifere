<section id="home-title-section">
    ...
    <h1 class="fade-in">Ateliers & expos</h1>
...
<main>
    <section class="section-activites" id="activites">
        ...
        <div class="article-container">
            <article>
                <img class="img-default fade-in" src="<?= IMAGES ?>/activites/activites.jpg" alt="Crayons et peincaux nécessaires aux ateliers créatifs.">
                <h3>Les ateliers</h3>
            ...
            <article>
                <img class="img-default fade-in" src="<?= IMAGES ?>/expositions/expositions.jpg" alt="Exposition du 27 Février 2018, les visiteurs examinent les toiles.">
    ...
    <div class="section-ateliers">
        ...
        <div class="grid-row">
            <div class="grid-col">
                <img class="fade-in-left" src="<?= IMAGES ?>/grid/grid1.jpg" alt="Atelier de dessin pour enfants">
                <img class="fade-in-bottom" src="<?= IMAGES ?>/grid/grid2.jpg" alt="Grande exposition de peinture">
            </div>
            <div class="grid-col">
                <img class="fade-in-top" src="<?= IMAGES ?>/grid/grid3.jpg" alt="Exposition d'art moderne">
                <img class="fade-in-right" src="<?= IMAGES ?>/grid/grid4.jpg" alt="Cours de peinture pour adultes">
            </div>
        </div>
