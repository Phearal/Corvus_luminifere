...
<main>
    <section class="section-activites">
        ...
        <div class="article-container">
            <article>
                <img src="<?= IMAGES ?>/activites/activites.jpg" alt="">
                <h3>Les ateliers</h3>
                <p>Ateliers de dessin et peinture pour enfants, ados et adultes. Laissez vous guider pas à pas quel que soit votre niveau, dans un cadre de bienveillance, de calme et de détente.</p>
                <a href="index.php?page=ateliers" class="btn-link">Découvrir</a>
            </article>
            <article>
                <img src="<?= IMAGES ?>/expositions/expositions.jpg" alt="">
                <h3>Les expositions</h3>
                <p>L’atelier organise régulièrement des expositions afin de mettre en avant le travail des participants aux ateliers ou d’artistes locaux.</p>
